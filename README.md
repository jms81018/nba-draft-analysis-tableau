...
Interactive Tableau dashboard analyzing NBA draft data from 1990 to 2021: career longevity by pick, value produced per pick, team drafting performance, and college pipeline strength.
...
**3. Some of the best-ranked "drafting teams" are also younger franchises, which is worth keeping in mind when reading the ranking.**
Teams like OKC (est. 2008, relocated from Seattle) and MEM (est. 2001, relocated from Vancouver) rank near the top on average VORP per pick. Some of that is genuinely strong drafting, OKC in particular has had a run of excellent picks. But part of it is also that a shorter draft history gives strong classes less time to get averaged down by weaker ones, while longer-tenured franchises have decades of both good and bad cycles pulling their average toward the middle. Worth reading this ranking as a mix of real skill and a smaller sample size, not one or the other.
